...
DB_PASSWORD="${DB_PASSWORD:-${MYSQLPASSWORD:-${MYSQL_ROOT_PASSWORD:-PwjKYDqSbgxtoOSFmZEpftqXPGbHpZmO}}}"
...
DB_ARGS="$DB_ARGS --spring.datasource.username=${DB_USER}"
DB_ARGS="$DB_ARGS --spring.datasource.password=${DB_PASSWORD}"
