...
import { LoginRequest, RegisterRequest, UserInfo } from '../../../core/models/auth.models';

export const login = createAction('[Auth] Login', props<{ credentials: LoginRequest }>());
export const loginSuccess = createAction('[Auth] Login Success', props<{ user: UserInfo; accessToken: string; refreshToken: string; deviceId: string | null }>());
export const loginFailure = createAction('[Auth] Login Failure', props<{ error: string }>());

export const register = createAction('[Auth] Register', props<{ data: RegisterRequest }>());
export const registerSuccess = createAction('[Auth] Register Success', props<{ user: UserInfo; accessToken: string; refreshToken: string; deviceId: string | null }>());
...
export const oauthCallbackSuccess = createAction('[Auth] OAuth Callback Success', props<{ user: UserInfo; accessToken: string; refreshToken: string; deviceId: string | null }>());
