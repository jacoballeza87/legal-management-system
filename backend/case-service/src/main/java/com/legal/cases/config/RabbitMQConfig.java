...
import org.springframework.amqp.rabbit.listener.RabbitListenerConfigurer;
...
public class RabbitMQConfig implements RabbitListenerConfigurer {
    ...
    public void configureRabbitListeners(RabbitListenerEndpointRegistrar registrar) {
        rabbitAdmin.declareQueue(userDeletedQueue());
        rabbitAdmin.declareQueue(documentUploadedQueue());
        rabbitAdmin.declareQueue(caseCreatedQueue());
    }
}