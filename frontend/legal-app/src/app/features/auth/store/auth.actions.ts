...
export const loginSuccess = createAction('[Auth] Login Success', props<{ user: any; accessToken: string; refreshToken: string }>());
...
export const oauthCallbackSuccess = createAction('[Auth] OAuth Callback Success', props<{ user: any; accessToken: string; refreshToken: string }>());
